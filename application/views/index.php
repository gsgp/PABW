...
<html lang="en">
  ...
  <head>
    ...
    <!-- Plugin CSS -->
    <link href="<?php echo base_url('aset/vendor/magnific-popup/magnific-popup.css')?>" rel="stylesheet" type="text/css">

    <!-- Custom styles for this template -->
    <link href="<?php echo base_url('aset/css/freelancer.min.css')?>" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">TUGAS PABW</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">Blablabla</a>
            </li>
            <li class="nav-item mx-0 mx-lg-1">
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container">
        ...
        <h1 class="text-uppercase mb-0">GASWARA SANI GUSPA P</h1>
        <hr class="star-light">
        <h2 class="font-weight-light mb-0">16523115</h2>
      </div>
    </header>
    ...
    <section class="portfolio" id="portfolio">
      <div class="container">
        <h2 class="text-center text-uppercase text-secondary mb-0">Blablabla</h2>
    ...
    <div class="copyright py-4 text-center text-white">
      <div class="container">
        <small>Copyright &copy; PABW 2017</small>
      </div>
    </div>
